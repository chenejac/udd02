...
import rs.ac.uns.ftn.informatika.udd.vezbe02.lucene.indexing.Indexer;
import rs.ac.uns.ftn.informatika.udd.vezbe02.lucene.model.IndexUnit;
import rs.ac.uns.ftn.informatika.udd.vezbe02.lucene.model.UploadModel;
	    ...
	    private void indexUploadedFile(UploadModel model) throws IOException{
	    	...
	    	for (MultipartFile file : model.getFiles()) {
	            ...
	            if(fileName != null){
	            	...
	            	Indexer.getInstance().add(indexUnit.getXContentBuilder());
	            }
	    	}
	    }
